...
let discount =
  age < 0
    ...
    : age < 18
      ...
      : age <= 65
        ? "Поздравляем! Ваша скидка 20%!!"
        : age <= 120
          ? "Поздравляем! Ваша скидка 30%!!!"
          : "Вы вампир что-ли?";
...
switch (age2) {
  case age2 < 0:
    ...
    break;
  case age2 < 18 || age2 === 0:
    discount2 = "Поздравляем! Ваша скидка 10%!";
    break;
  case age2 <= 65:
    discount2 = "Поздравляем! Ваша скидка 20%!!";
    break;
  case age2 <= 120:
    discount2 = "Поздравляем! Ваша скидка 30%!!!";
    break;
  default:
    discount2 = "Вы вампир что-ли?";
}
...
alert(`Итоговая стоимость доставки: ${priсe}$`);
